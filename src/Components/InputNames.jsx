...
export default function InputNames(props) {
  ...
  const [numberOfGroupsOrMaxSize, setNumberOfGroupsOrMaxSize] =
    useState("numberOfGroups");
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <div>
          ...
          <h3>
            <span
              style={
                numberOfGroupsOrMaxSize === "numberOfGroups"
                  ? { opacity: "1" }
                  : { opacity: "0.5" }
              }
            ...
            <span
              style={
                numberOfGroupsOrMaxSize === "maxSize"
                  ? { opacity: "1" }
                  : { opacity: "0.5" }
              }
